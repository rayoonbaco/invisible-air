...
setlocal
cd /d "%~dp0"
title Invisible Air SV2-9 Verification

echo.
echo Invisible Air - SV2-9 test, terrain-driven flow, launch, and confirmation
echo.
...
echo.
echo COMPLETE - tests passed, measured terrain prepared, and terrain-driven flow opened.
pause
exit /b 0
