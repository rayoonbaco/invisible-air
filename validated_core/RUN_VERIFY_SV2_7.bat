...
setlocal
cd /d "%~dp0"
title Invisible Air SV2-7 Verification

echo.
echo Invisible Air - SV2-7 test, launch, and confirmation
echo.
...
if not "%RESULT%"=="0" (
  echo.
  echo The tests passed, but browser launch was not confirmed. Error code: %RESULT%
...
echo.
echo COMPLETE - tests passed and both confirmation pages opened.
pause
exit /b 0
