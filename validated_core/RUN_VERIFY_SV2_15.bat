...
setlocal
cd /d "%~dp0"
title Invisible Air SV2-15 Verification

echo.
echo Invisible Air - SV2-15 test, citation surface, launch, and confirmation
echo.
...
echo.
echo COMPLETE - tests passed, measured terrain prepared, and citation surface opened.
pause
exit /b 0
