...
setlocal
cd /d "%~dp0"
title Invisible Air SV2-8 Verification

echo.
echo Invisible Air - SV2-8 test, terrain preparation, launch, and confirmation
echo.
...
echo.
echo COMPLETE - tests passed, terrain preparation ran, and both pages opened.
pause
exit /b 0
