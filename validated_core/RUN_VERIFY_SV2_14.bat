...
setlocal
cd /d "%~dp0"
title Invisible Air SV2-14 Verification

echo.
echo Invisible Air - SV2-14 test, observation evidence contract, launch, and confirmation
echo.
...
echo.
echo COMPLETE - tests passed, measured terrain prepared, and observation evidence contract opened.
pause
exit /b 0
