...
setlocal
cd /d "%~dp0"
title Invisible Air SV2-10 Verification

echo.
echo Invisible Air - SV2-10 test, elevation lighting and local relief, launch, and confirmation
echo.
...
echo.
echo COMPLETE - tests passed, measured terrain prepared, and elevation lighting and local relief opened.
pause
exit /b 0
