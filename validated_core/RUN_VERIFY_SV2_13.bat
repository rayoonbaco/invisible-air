...
setlocal
cd /d "%~dp0"
title Invisible Air SV2-13 Verification

echo.
echo Invisible Air - SV2-13 test, evidence-time alignment, launch, and confirmation
echo.
...
echo.
echo COMPLETE - tests passed, measured terrain prepared, and evidence-time alignment opened.
pause
exit /b 0
