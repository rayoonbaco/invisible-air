...
setlocal
cd /d "%~dp0"
title Invisible Air SV2-16 Verification

echo.
echo Invisible Air - SV2-16 test, evidence-state vocabulary, launch, and confirmation
echo.
...
echo.
echo COMPLETE - tests passed, measured terrain prepared, and evidence-state vocabulary opened.
pause
exit /b 0
