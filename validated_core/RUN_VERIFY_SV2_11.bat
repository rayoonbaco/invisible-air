...
setlocal
cd /d "%~dp0"
title Invisible Air SV2-11 Verification

echo.
echo Invisible Air - SV2-11 test, air volume, launch, and confirmation
echo.
...
echo.
echo COMPLETE - tests passed, measured terrain prepared, and air volume opened.
pause
exit /b 0
